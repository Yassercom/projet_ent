...
const TeacherProfilePage: React.FC<TeacherProfilePageProps> = ({ onLogout }) => {
  // État pour les informations du profil (certains champs sont en lecture seule)
  const [profileData, setProfileData] = useState({
    firstName: 'Mohammed',
    lastName: 'El Alaoui',
    email: 'm.elalaoui@um5.ac.ma',
    phone: '0661234567',
    teacherId: 'PROF2023456',
  ...
  const handleProfileChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const editableFields = ['phone', 'office', 'address'];
        ...
        <div className="p-6">
          {isEditing ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="teacherId" className="block text-sm font-medium text-gray-700 mb-1">
                    ID Enseignant <span className="text-xs text-gray-500">(lecture seule)</span>
                  </label>
                  <input
                    type="text"
                    id="teacherId"
                ...
                <div>
                  <label htmlFor="department" className="block text-sm font-medium text-gray-700 mb-1">
                    Département <span className="text-xs text-gray-500">(lecture seule)</span>
                  </label>
                  <input
                    type="text"
                    id="department"
                ...
                <div>
                  <label htmlFor="specialization" className="block text-sm font-medium text-gray-700 mb-1">
                    Spécialisation <span className="text-xs text-gray-500">(lecture seule)</span>
                  </label>
                  <input
                    type="text"
                    id="specialization"
                ...
                <div>
                  <label htmlFor="joinDate" className="block text-sm font-medium text-gray-700 mb-1">
                    Date d'entrée <span className="text-xs text-gray-500">(lecture seule)</span>
                  </label>
                  <input
                    type="date"
                    id="joinDate"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">ID Enseignant</h3>
                <p className="mt-1">{profileData.teacherId}</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Spécialisation</h3>
                <p className="mt-1">{profileData.specialization}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">Bureau</h3>
                <p className="mt-1">{profileData.office}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-500">Date d'entrée</h3>
                <p className="mt-1">{new Date(profileData.joinDate).toLocaleDateString()}</p>
              </div>
              <div className="md:col-span-2">

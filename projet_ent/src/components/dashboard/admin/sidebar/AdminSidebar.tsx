...
const AdminSidebar = () => {
  ...
  return (
    <aside 
      className={`bg-est-green text-white h-screen transition-all duration-300 ${
        collapsed ? 'w-20' : 'w-64'
      } fixed left-0 top-0 z-30 flex flex-col shadow-lg`}
    >
      <div className="p-4 flex items-center justify-between">
        {!collapsed && (
          <div className="font-bold text-xl">Admin EST</div>
        )}
        <button
      ...
      <div className="p-4">
        <a
          href="/login"
          className={`flex items-center py-3 px-4 rounded-lg transition-colors text-white/80 hover:bg-green-800 hover:text-white`}
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
